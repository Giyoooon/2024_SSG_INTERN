...
--delete from emp2 where ename = 'BBB'
merge 
 into emp2 e
using dual
...
--------------------------------------
--------------------------------------
--> 트랜잭션(Transaction) -> TCL(Transaction Control Language)
 -- commit  : disk에 반영 
 -- rollback : memory 에서 해제
 -- savepoint : 시점찍기 
--> dept3 생성
create table dept3
as
